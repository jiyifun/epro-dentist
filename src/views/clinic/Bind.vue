      ...
      <form @submit.prevent="submit">
        <div class="register-form">
          <div class="form-raw">
            ...
            <input class="register-form__input" type="text" placeholder="请输入诊所ID" name="clinic" id="clinic" v-model="phone">
          </div>
        </div>
        <div class="forgot">
          查看诊所ID?
        ...
        <div class="wx-form-btn-wrap">
          <input class="submit-btn" type="submit" value="绑定诊所">
        </div>
      </form>
  </div>
</template>
...
.register-form__icon.clinic {
  margin-top: 36px;
  margin-left: 30px;
  background-image: url('../../assets/icon/icon_clinic.png');
}
.forgot {
